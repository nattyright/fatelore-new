...
Domestic travel is a bit more subdued. ~~Civilians commonly use city leylines as a way to travel from point A to B, by ‘skating’ on the leylines with their artificial circuits. (Heh)~~. Public transport is also a lot more common in the current year, with some cities having trains, railways, funiculars, subways, skyways and so on. However, what all of these numerous systems have in common is that they are linked to leylines. **Without leylines, transportation systems simply do not work**, hence why nomadic cities value them so much.
